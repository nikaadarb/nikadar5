...
<div id = "form">
  ...
  <form action="index.php"
    ...
    <label>
      ...
      <select name="ability[]"
          ...
          <option value="2" <?php print(in_array('2', $values['ability']) ? 'selected ="selected"' : '');?>>телепорт</option>
          <option value="3" <?php print(in_array('3', $values['ability']) ? 'selected ="selected"' : '');?>>умение летать</option>
          <option value="4" <?php print(in_array('4', $values['ability']) ? 'selected ="selected"' : '');?>>не стареть</option>
      </select>
      </label><br />
      <label>
      Биография<br />
  ...
  if(empty($_SESSION['login'])){
   echo'
   <div class="login">
    <p>Если у вас уже есть аккаунт, тогда вы можете <a href="login.php">войти</a></p>
   </div>';
  }
  else{
    echo '
